...
class Config:
    ...
    # Owner
    OWNER_ID = int(os.environ.get("OWNER_ID", 6045293810))
    LOGGER_ID = int(os.environ.get("LOGGER_ID", -1001772857132))
    
    # MongoDB (optional)
    MONGO_URL = os.environ.get("MONGO_URL", "mongodb+srv://LUSTIFYXMUSIC:Abhi77394@lustifymusic.evxnqby.mongodb.net/?retryWrites=true&w=majority&appName=LUSTIFYMUSIC")
